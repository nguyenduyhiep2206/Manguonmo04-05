...
if ( ! class_exists( 'The_Fashion_Woocommerce_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class The_Fashion_Woocommerce_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new The_Fashion_Woocommerce_WPTT_WebFont_Loader( $url );
