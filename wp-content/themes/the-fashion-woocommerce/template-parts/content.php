    ...
    <?php if( get_theme_mod( 'the_fashion_woocommerce_date_hide',true) != '' || get_theme_mod( 'the_fashion_woocommerce_comment_hide',true) != '' || get_theme_mod( 'the_fashion_woocommerce_author_hide',true) != '' || get_theme_mod( '
      ...
      <div class="metabox">
        <?php if( get_theme_mod( 'the_fashion_woocommerce_date_hide',true) != '') { ?>
          <span class="entry-date"><i class="<?php echo esc_attr(get_theme_mod('the_fashion_woocommerce_date_icon','fa fa-calendar')); ?>"></i><a href="<?php echo esc_url( get_day_link( $the_fashion_woocommerce_archive_year, $the_fashion_woocommerce_archive_month, $the_fashion_woocommerce_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><?php echo esc_html( get_theme_mod('the_fashion_woocommerce_metabox_separator_blog_post','|') ); ?>
        <?php } ?>
        <?php if( get_theme_mod( 'the_fashion_woocommerce_comment_hide',true) != '') { ?>
          <span class="entry-comments"><i class="<?php echo esc_attr(get_theme_mod('the_fashion_woocommerce_comment_icon','fas fa-comments')); ?>"></i><?php comments_number( __('0 Comments','the-fashion-woocommerce'), __('0 Comments','the-fashion-woocommerce'), __('% Comments','the-fashion-woocommerce') ); ?></span><?php echo esc_html( get_theme_mod('the_fashion_woocommerce_metabox_separator_blog_post','|') ); ?>
        <?php } ?>
        <?php if( get_theme_mod( 'the_fashion_woocommerce_author_hide',true) != '') { ?>
          <span class="entry-author"><i class="<?php echo esc_attr(get_theme_mod('the_fashion_woocommerce_author_icon','fa fa-user')); ?>"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span><?php echo esc_html( get_theme_mod('the_fashion_woocommerce_metabox_separator_blog_post','|') ); ?>
        <?php } ?>
        <?php if( get_theme_mod( 'the_fashion_woocommerce_time_hide',true) != '') { ?>
          <span class="entry-time"><i class="<?php echo esc_attr(get_theme_mod('the_fashion_woocommerce_time_icon','fas fa-clock')); ?>"></i> <?php echo esc_html( get_the_time() ); ?></span>
        <?php }?>
      </div>
    <?php }?>
