...
?>  
<?php
  $the_fashion_woocommerce_content = apply_filters( 'the_content', get_the_content() );
  $the_fashion_woocommerce_video = false;
  // Only get video from the content if a playlist isn't present.
  if ( false === strpos( $the_fashion_woocommerce_content, 'wp-playlist-script' ) ) {
    $the_fashion_woocommerce_video = get_media_embedded_in_content( $the_fashion_woocommerce_content, array( 'video', 'object', 'embed', 'iframe' ) );
  }
?>
<?php 
    ...
    <div class="box-img">
      <?php
        if ( ! is_single() ) {
          ...
          if ( ! empty( $the_fashion_woocommerce_video ) ) {
            foreach ( $the_fashion_woocommerce_video as $the_fashion_woocommerce_video_html ) {
              echo '<div class="entry-video">';
                echo $the_fashion_woocommerce_video_html;
              echo '</div>';
            }
          };
        }; 
