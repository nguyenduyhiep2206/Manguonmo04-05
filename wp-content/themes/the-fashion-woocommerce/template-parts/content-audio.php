...
<?php
  ...
  $the_fashion_woocommerce_audio = false;
  // Only get audio from the content if a playlist isn't present.
  if ( false === strpos( $the_fashion_woocommerce_content, 'wp-playlist-script' ) ) {
    $the_fashion_woocommerce_audio = get_media_embedded_in_content( $the_fashion_woocommerce_content, array( 'audio' ) );
  }
?>  
    ...
    <div class="box-img">
      <?php
        if ( ! is_single() ) {
          ...
          if ( ! empty( $the_fashion_woocommerce_audio ) ) {
            foreach ( $the_fashion_woocommerce_audio as $the_fashion_woocommerce_audio_html ) {
              echo '<div class="entry-audio">';
                echo $the_fashion_woocommerce_audio_html;
