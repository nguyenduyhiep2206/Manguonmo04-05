...
if (!class_exists('bloggernewspaper_post_carousel')) {

  class bloggernewspaper_post_carousel extends WP_Widget
  {
    public function __construct()
    {
      $widget_ops = array(
        'classname' => 'bloggernewspaper_post_carousel',
        'description' => __('(blog carousel style) Displays latest posts or posts from a choosen category.', 'blogger-newspaper'),
        'customize_selective_refresh' => true,
      );
      parent::__construct('bloggernewspaper-latestpost-carousel', __('&hearts; bloggernewspaper-Post Carousel', 'blogger-newspaper'), $widget_ops);
      $this->alt_option_name = 'bloggernewspaper_latestpost_carousel';
    }
...
?>
    ...
    ?>
      ...
      <p>
        <label for="<?php echo $this->get_field_id('slidesto_show'); ?>"><?php esc_html_e('slides to show', 'blogger-newspaper'); ?></label>
      ...
      <p>
        <label for="<?php echo $this->get_field_id('auto_play'); ?>"><?php esc_html_e('Auto play', 'blogger-newspaper') ?></label>
        <select id="<?php echo $this->get_field_id('auto_play'); ?>" name="<?php echo $this->get_field_name('auto_play'); ?>" class="widefat">
          <option value="true" <?php if ('true' == $instance['auto_play']) echo 'selected="selected"'; ?>><?php esc_html_e('ON', 'blogger-newspaper') ?></option>
          <option value="false" <?php if ('false' == $instance['auto_play']) echo 'selected="selected"'; ?>><?php esc_html_e('OFF', 'blogger-newspaper') ?></option>
        </select>
      </p>
...
function bloggernewspaper_latest_post_carousel()
{
  register_widget('bloggernewspaper_post_carousel');
}
add_action('widgets_init', 'bloggernewspaper_latest_post_carousel');
